...
<html>
    ...
    <body>
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Nova dúvida</li>
        </ol>
        ...
        <section class="col-lg-10 col-sm-8 area-principal" >
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" name="pergunta" id="pergunta"></textarea>
                    <c:if test="${errors.pergunta != null}"><p class="text-danger">${errors.pergunta}</p></c:if>
