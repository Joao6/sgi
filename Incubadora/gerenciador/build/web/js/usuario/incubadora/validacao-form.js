...
$(document).ready(function () {
    ...
    if (id !== null && id !== "") {
        $("#gestor-nome").attr({'data-toggle': 'tooltip', 'title': 'Nome do Empreendedor'});
        $("#gestor-sobrenome").attr({'data-toggle': 'tooltip', 'title': 'Sobrenome do Empreendedor'});
        $("#gestor-telefone").attr({'data-toggle': 'tooltip', 'title': 'Telefone'});
        $("#gestor-email").attr({'data-toggle': 'tooltip', 'title': 'Email'});
        $("#gestor-senha").attr({'data-toggle': 'tooltip', 'title': 'Senha'});
    ...
    $(document).on('submit', '#form-incubadora', function (e) {
