...
$(document).ready(function () {
  ...
  var id = $("#empreendedor-id").val();
  if (id !== null && id !== "") {
    $("#empreendedor-nome").attr({'data-toggle': 'tooltip', 'title': 'Nome do Empreendedor'});
    $("#empreendedor-telefone").attr({'data-toggle': 'tooltip', 'title': 'Telefone'});
    $("#empreendedor-email").attr({'data-toggle': 'tooltip', 'title': 'Email'});
    $("#empreendedor-senha").attr({'data-toggle': 'tooltip', 'title': 'Senha'});
  ...
  $(document).on('submit', '#form-empreendedor', function (e) {
