            ...
            <article class="black-text col s12 m12 l12 card">
               ...
               <table class="bordered">
                  ...
                  <tr data-ng-repeat="criterio in criterioList| orderBy:'nome' | byEixoId:eixo.id">
                     ...
                     <td class="center-align">
                        <a href="#!" class="btn-floating blue"><i class="material-icons">edit</i></a>
                     </td>
                     <td class="center-align">
                         <a href="#!" class="btn-floating red" data-ng-click="deleteCriterio(criterio.id)"><i class="material-icons">clear</i></a>
                     </td>
                  </tr>
