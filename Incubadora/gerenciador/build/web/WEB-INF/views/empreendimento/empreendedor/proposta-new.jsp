                        ...
                        <li class="collection-item" data-ng-show="isActive(5)">
                           ...
                           <div class="card card-content">
                              <form name="form5">
                                 ...
                                 <div class="row">
                                    <div class="col s12 m12 l12">
                                       <button data-ng-click="addApNegocio(apresentacaoNegocio)" data-ng-disabled="!form5.$valid" class="btn green valign white-text accent-5 truncate" style="width: 100% !important">Salvar</button> 
                                    </div>
                                 </div>
                              </form>
                           </div>
